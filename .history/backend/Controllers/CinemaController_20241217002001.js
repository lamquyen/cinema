...
export const createCinema = async(req, res) =>{
    try{
        const {cinemaName,location,img01,address,maps,introduce01,introduce02,room} = req.body;
        const newCinema = new Cinema({cinemaName,location,img01,address,maps,introduce01,introduce02,room});
