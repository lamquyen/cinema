...
export const createCinema = async(req, res) =>{
    try{
        const {cinemaName,location,img01,address,map,introduce01,introduce02} = req.body;
        const newCinema = new Cinema({cinemaName,location,img01,address,map,introduce01,introduce02});
