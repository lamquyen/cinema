                    ...
                    <div className="h-fit w-[25%] font-nunito rounded-lg border-t-4 border-orange-600 float-right ">
                        <div className="bg-white w-full p-4">
                            <div className="border-dashed border-b-[1px] border-black pb-4 " >
                                ...
                                <div className="mt-4">
                                    <p className="flex font-bold">Galaxy Tân Bình - <p className="font-normal"> {showtimeData.room}</p> </p>
                                    <p>Suất: <span className="font-bold">{showtimeData.times}</span> - Chủ nhật, 8/12/2024</p>
                                </div>
