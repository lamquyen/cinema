...
const QuickBooking = () => {
      ...
      const timesList = showtimesData.reduce((acc, showtime) => {
        if (showtime.days && Array.isArray(showtime.days)) {
          showtime.days.forEach((day) => {
            ...
            // Kiểm tra nếu showtime.times là mảng, nếu không thì chuyển nó thành mảng
  ...
  const handleDateChange = (date) => {
    ...
    const filteredTimes = showingMovies
      ...
      .flatMap((showtime) => {
        // Kiểm tra times là mảng, nếu không phải thì chuyển thành mảng
        return Array.isArray(showtime.times) ? showtime.times : [showtime.times];
      });
