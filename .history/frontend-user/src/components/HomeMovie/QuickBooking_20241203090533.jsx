  ...
  return (
    <div className="quick-booking-container bg-white p-4 shadow-lg rounded-lg">
      <div className="flex justify-between items-center gap-4">
        {/* Chọn phim */}
        <div>
          <label className="block text-sm font-medium text-gray-700">1. Chọn Phim</label>
          <select
        ...
        {/* Chọn rạp */}
        <div>
          <label className="block text-sm font-medium text-gray-700">2. Chọn Rạp</label>
          <select
            className="border rounded-md px-4 py-2 w-full"
        ...
        {/* Chọn ngày */}
        <div>
          <label className="block text-sm font-medium text-gray-700">3. Chọn Ngày</label>
          <select
            className="border rounded-md px-4 py-2 w-full"
            value={selectedDate}
        ...
        {/* Chọn suất */}
        <div>
          <label className="block text-sm font-medium text-gray-700">4. Chọn Suất</label>
          <select
            className="border rounded-md px-4 py-2 w-full"
            value={selectedTime}
