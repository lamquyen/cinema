...
const QuickBooking = () => {
  ...
  const handleDateChange = (date) => {
    ...
    // Cập nhật showtimeId cho ngày và suất chiếu đã chọn
    const showtime = showingMovies
  ...
  return (
    <div className="quick-booking-container">
      ...
      <Link
        ...
        disabled={!selectedMovie || !selectedCinema || !selectedDate || !selectedTime || !showtimeId}
      >
        Mua vé nhanh
      </Link>
    </div>
