        ...
        {activeTab === "dangChieu" && (
          <div className="boxM">
            {showingM.map((phim) => (
              <div 
                key={phim.id}
                className="relative group bg-gray-200 p-4 rounded-lg shadow-lg hover:shadow-xl cardM boxCard"
              >
                <img src="https://cdn.galaxycine.vn/media/2024/11/19/bo-tu-bao-thu-500_1732008585578.jpg" className="imgBox"/>
                <p>{phim.ten}</p>
