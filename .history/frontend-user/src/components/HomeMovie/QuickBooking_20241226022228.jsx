...
const QuickBooking = () => {
  ...
  const handleTimeChange = (date, time) => {
    ...
    // Lấy showtimeId cho suất chiếu đã chọn từ availableTimes
    const showtime = availableTimes[date]?.find((t) => t.time === time);
    if (showtime) {
      setShowtimeId(showtime.showtimeId);  // Lưu showtimeId vào state
      console.log("Selected Showtime ID:", showtime.showtimeId); // In ra showtimeId khi chọn suất
    }
  };
