    ...
    <>
      ...
      <div>
        ...
        <div className="cinemaInfo">
          <div className="grid lg:grid-cols-3 grid-cols-1  grid-flow-row  gap-y-6  my-0 mx-auto md:items-center ml-[20%] mr-[20%]   md:px-4 sm:px-[45px] px-[16px] py-6  w-full">
            <div class="col-span-2">
              <h1 class="text-2xl  font-medium  dark:text-white mx-2">Galaxy Tân Bình</h1>
