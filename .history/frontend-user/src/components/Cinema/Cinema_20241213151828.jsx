      ...
      <div>
        ...
        <div className="cinemaInfo">
          ...
          <div className="containerCinema">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 relative md:gap-8 gap-2">
            ...
            {filteredMovies.length > 0 ? (
                filteredMovies.map((movie) => (
                  <>
                    <div
                    key={movie.id}
                    className={`relative text-center mb-2 ${selectedMovie === movie.id ? "border border-blue-500" : ""}`}
