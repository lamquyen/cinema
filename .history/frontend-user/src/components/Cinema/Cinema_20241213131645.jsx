...
function Cinema() {
  ...
  const movies = [
    {
      ...
      rating: 9.3,
      type: "T16",
      showDates: ["2024-12-13T00:00:00Z", "2024-12-14T00:00:00Z"],
    },
    {
      id: 2,
      ...
      rating: 7.1,
      type: "T13",
      showDates: ["2024-12-10T00:00:00Z"],
    },
    // Thêm các phim khác...
  ];
  ...
  const filteredMovies = movies.filter((movie) => {
    // So sánh ngày phát hành với ngày được chọn
    return new Date(selectedDate) >= new Date(movie.releaseDate);
  });
