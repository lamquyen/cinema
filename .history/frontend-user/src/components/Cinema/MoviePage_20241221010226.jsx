...
const MoviePage = ({ cinemaLocation }) => {
  ...
  const filteredShowtimes = showtimes.filter((showtime) => {
    const showtimeDate = moment(showtime.date, "DD/MM/YYYY").format("YYYY-MM-DD"); // Đổi định dạng nếu cần
    console.log("Comparing:", showtimeDate, selectedDate); // Kiểm tra logic lọc
