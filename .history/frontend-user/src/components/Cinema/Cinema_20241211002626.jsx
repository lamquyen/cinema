    ...
    <>
      ...
      <div>
        ...
        <div className="cinemaInfo">
          <div className="grid lg:grid-cols-3 grid-cols-1  grid-flow-row  gap-y-6  my-0 mx-auto md:items-center ml-[25%]   md:px-4 sm:px-[45px] px-[16px] py-6  w-full">
            <div class="col-span-2">
              <h1 class="text-2xl p-0.5 font-medium  dark:text-white mx-2">Galaxy Tân Bình</h1>
              ...
              <p class="text-sm">
                ...
                <a
                  class="text-blue-10 transition-all duration-300"
                  href="tel:1900 2224"
                >
                  1900 2224
                </a>{" "}
