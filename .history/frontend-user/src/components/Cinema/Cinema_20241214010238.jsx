    ...
    <>
      ...
      <div>
        ...
        <div className="cinemaInfo">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 mt-8  my-0 mx-auto items-center py-6 (24px px-[16px] bg-white max-w-[1200px] ">
            <div className="bg-white p-4">
              <div className="mb-4">
              ...
              <div className="">
                  <ul>
                    <li>
                      ...
                      <strong>246 Nguyễn Hồng Đào, Q.TB, Tp.HCM</strong>
                    </li>
                    <li>
                  ...
                  <div className="mt-4">
                      <iframe className="w-full h-[250px]" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.2722042714763!2d106.64075729999999!3d10.7904517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752ead62de80b7%3A0x5cde8036b5d68e56!2zR2FsYXh5IFTDom4gQsOsbmg!5e0!3m2!1svi!2s!4v1442046380852"></iframe>
                  </div>
                  <div className="mt-4">
                      <p style={{fontFamily:"sans-serif"}}>Galaxy Tân Bình, hay còn được các Stars quen gọi là “Galaxy Nguyễn Hồng Đào” do tọa lạc tại số 246 Nguyễn Hồng Đào, Q.TB, Tp.HCM. </p>
                      <p >&nbsp;</p>
                      <p style={{fontFamily:"sans-serif"}}> Với diện tích hơn 3000 m2 gồm 5 phòng chiếu , Galaxy Tân Bình được đánh giá như một thế giới Hollywood thu nhỏ của TP.HCM. Cùng sự hỗ trợ tư vấn thiết kế và lắp đặt bởi các chuyên gia của Tập đoàn Warner Bros đến từ Hollywood, các phòng chiếu 2D và 3D với màn hình chiếu sắc nét và dàn âm thanh Dolby 7.1 bậc nhất tại Việt Nam. Đây là cụm </p>
                  </div>
              </div>
            </div>
          </div>
