...
const MovieList = ({ groupedShowtimes }) => {
  ...
  const isShowtimeExpired = (showtime) => {
    ...
    const showtimeDate = new Date(currentTime); // Clone thời gian hiện tại
    showtimeDate.setHours(hours, minutes, 0, 0); // Cập nhật giờ, phút vào ngày hiện tại
    
    // Kiểm tra nếu ngày của suất chiếu khác với ngày hiện tại
    const isSameDay = 
    ...
    return !isSameDay || showtimeDate < currentTime; // Suất chiếu hết hạn nếu không cùng ngày hoặc đã qua
  };
