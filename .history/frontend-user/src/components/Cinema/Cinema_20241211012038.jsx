        ...
        <div className="cinemaInfo">
          <div className="titleCinema">
            <div class="col-span-2 ml-[20%]">
              <h1 class="text-2xl  font-medium  dark:text-white mx-2">Rạp Hồ Chí Minh</h1>
          ...
          <div className="containerCinema">
            ...
            <div class="mb-4"><span class="border-l-4 border-solid border-blue-10 mr-2"></span><h1 class="text-xl inline-block uppercase font-bold m-0">Phim</h1></div>
            </div>
          </div>
        </div>
      </div>
