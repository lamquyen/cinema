...
function RevenueAndRoom() {
  ...
  const handleBookingUpdate = (data) => {
    const newRevenue = calculateTotalRevenue(data);
  
    setTotalRevenue((prevRevenue) => ({
      totalSeatPrice: prevRevenue.totalSeatPrice + newRevenue.totalSeatPrice,
      totalFoodPrice: prevRevenue.totalFoodPrice + newRevenue.totalFoodPrice,
      totalSeat: prevRevenue.totalSeat + newRevenue.totalSeat,
      totalSeatN: prevRevenue.totalSeatN + newRevenue.totalSeatN,
      totalSeatV: prevRevenue.totalSeatV + newRevenue.totalSeatV,
      totalSeatC: prevRevenue.totalSeatC + newRevenue.totalSeatC,
      totalCombo: prevRevenue.totalCombo + newRevenue.totalCombo,
      totalCorn: prevRevenue.totalCorn + newRevenue.totalCorn,
      totalPepsi: prevRevenue.totalPepsi + newRevenue.totalPepsi,
    }));
  };
    ...
    if (showtimesData.length > 0) {
      const fetchBookingData = async () => {
        try {
          ...
          setBookingData(allBookings.flat()); // Cập nhật state bookingData
          console.log("All bookings:", allBookings);
  
          // Gọi handleBookingUpdate để tính toán tổng doanh thu
          handleBookingUpdate(allBookings.flat());
        } catch (error) {
  ...
  }, [showtimesData]); // Gọi lại khi showtimesData thay đổi
