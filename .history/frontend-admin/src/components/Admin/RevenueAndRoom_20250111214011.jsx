...
function RevenueAndRoom() {
  ...
  const [totalRevenue, setTotalRevenue] = useState({ totalSeatPrice: 0, totalFoodPrice: 0, totalSeat: 0 });
  ...
  const calculateTotalRevenue = (data) => {
    ...
    let seatC = 0; // Đếm số ghế khác
    
    const countSeats = (seat) => {
      let seatN = 0; // Đếm số ghế normal
      let seatV = 0; // Đếm số ghế vip
      let seatC = 0; // Đếm số ghế khác
    ...
    return data.reduce((total, item) => {
      ...
      console.log("seatN:", seatN);
      console.log("seatV:", seatV);
      ...
      return total;
    }, { totalSeatPrice: 0, totalFoodPrice: 0 , totalSeat: 0});
  };
