...
function RevenueAndRoom() {
  ...
  const calculateTotalRevenue = (data) => {
    ...
    total.totalPepsi += pepsi; // Số ghế khác
      ...
      return total;
    }, { totalSeatPrice: 0, totalFoodPrice: 0 , totalSeat: 0, totalSeatN: 0, totalSeatV: 0, totalSeatC: 0, totalCombo: 0, totalCorn: 0, totalPepsi: 0});
  };
