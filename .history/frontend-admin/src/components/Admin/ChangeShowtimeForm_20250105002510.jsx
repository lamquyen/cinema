...
function ChangeShowtimeForm({ onClose, showtime, onSave, timeSlots }) {
  ...
  const [selectedMovieId, setSelectedMovieId] = useState(showtime.movie?._id || ""); // ID phim được chọn
  ...
  return (
    <div className="form-container">
      ...
      {/* Display error message if time is invalid */}
      {errorMessage && <p style={{ color: "red" }}>{errorMessage}</p>}

      <div className="form-actions">
        <button onClick={handleSave} disabled={errorMessage}>Lưu</button>
