...
useEffect(() => {
  ...
  return (
    <div className="container">
      ...
      const revenueForShowtime = calculateTotalRevenue(bookingsForShowtime);
      ...
      return (
        <tr key={showtime._id}>
          ...
          <td>{revenueForShowtime.totalSeatV}</td> {/* Doanh thu ghế VIP cho showtime này */}
          <td>{revenueForShowtime.totalCombo}</td> {/* Doanh thu combo cho showtime này */}
          <td>{revenueForShowtime.totalSeatPrice + revenueForShowtime.totalFoodPrice} đ</td> {/* Tổng doanh thu cho showtime này */}
        </tr>
      );
    })
              ) : (
