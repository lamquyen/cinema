            ...
            <div className="room w">
              ...
              <div className="total-revenue-room">
                ...
                <div className="revenue-content">
                  ...
                  <span>Vé Bán:</span>{" "}
                  <span>
                    <IoTicketOutline style={{ color: "green" }} />: {totalRevenue.totalSeatN}
                  </span>{" "}
                  <span>
                    <IoTicketOutline style={{ color: "red" }} />: {totalRevenue.totalSeatV}
                  </span>{" "}
                  <span>
                    <IoTicketOutline style={{ color: "purple" }} />: {totalRevenue.totalSeatC}
                  </span>
                  <div className="note">
                    <p>
                ...
                <div className="line"></div>
                <div className="total">
                  <h3>{totalRevenue.totalFoodPrice + totalRevenue.totalSeatPrice} đ</h3>
                </div>
              </div>
            </div>
          </div>
