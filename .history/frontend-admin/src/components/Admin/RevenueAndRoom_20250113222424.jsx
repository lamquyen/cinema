  ...
  const handleBookingUpdate = (data) => {
    ...
    data.forEach((booking) => {
      ...
      if (booking && booking.seat && booking.foodNames) {
        ...
        // Tính tổng số ghế VIP nếu có thông tin về ghế VIP
        ...
        try {
          ...
          const calculatedRevenue = showtimesData.map((showtime, index) => {
            ...
            bookingList.forEach((booking) => {
              ...
              booking.foodNames.forEach((food) => {
                if (
                  food.name &&
                  food.name !== "Corn" &&
                  food.name !== "PepSi 32Oz"
                ) {
                  totalCombo += 1;
                }
              });
                        ...
                        showtimesData.map((showtime, index) => {
                          ...
                          return (
                            <tr key={showtime._id}>
                              ...
                              <td>{revenue.totalCombo}</td>
                       
                              <td>
                                {revenue.totalSeatPrice +
                                  revenue.totalFoodPrice}{" "}
                                đ
                              </td>
                            </tr>
                          );
  ...
  <div className="total-revenue-room">
    ...
    <div className="revenue-content">
      ...
      <div className="total">
        <h3>
          Tổng doanh thu:{" "}
          {(totalRevenue.totalFoodPrice + totalRevenue.totalSeatPrice).toLocaleString()} đ
        </h3>
      </div>
    </div>
  </div>
