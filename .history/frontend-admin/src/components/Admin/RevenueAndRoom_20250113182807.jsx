...
function RevenueAndRoom() {
  ...
  const calculateTotalRevenue = (data) => {
    return data.reduce(
      (total, item) => {
        console.log("Item data:", item); // Kiểm tra item
        ...
        console.log("Seats:", seat); // Kiểm tra seats
        console.log("Food Names:", foodNames); // Kiểm tra foodNames
        ...
        console.log("Total after iteration:", total); // Kiểm tra total
  ...
  useEffect(() => {
    if (showtimesData.length > 0) {
      const revenue = calculateTotalRevenue(bookingData); // Tính toán doanh thu từ bookingData
      setTotalRevenue(revenue); // Cập nhật lại state
    }
  }, [showtimesData, bookingData]); // Cập nhật lại khi showtimesData hoặc bookingData thay đổi
                    ...
                    <tbody>
                      {showtimesData.length > 0 ? (
                        showtimesData.map((showtime, index) => {
                          ...
                          console.log("Bookings for this showtime:", bookingsForShowtime); // Kiểm tra bookings
                          ...
                          return (
                            <tr key={showtime._id}>
                              ...
                              <td>{console.log(revenueForShowtime.totalSeatV) }</td>{" "}
