                    ...
                    <div className='screen hig'>
                        ...
                        <div className='total-revenue-room'>
                            ...
                            <div className='revenue-content'>
                                ...
                                <p>Vé Bán:</p> <span><IoTicketOutline style={{color:'green'}}/>: 60</span> <span><IoTicketOutline style={{color:'red'}}/>: 30</span> <span><IoTicketOutline style={{color:'purple'}}/>: 10</span>
                                <div className='note'>
