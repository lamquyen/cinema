...
{/* Hiển thị suất chiếu */}
{/* Hiển thị suất chiếu */}
{selectedRoom && selectedRoom.showtimes && selectedRoom.showtimes[selectedDate] ? (
        ...
        {showtime.movie ? (
          <>
            ...
            <div className="poster">
              <img src={showtime.movie.img} alt={showtime.movie.title} />
            </div>
            <p>
