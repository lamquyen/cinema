...
function ShowtimeForm({ onClose, cinemaId, roomId }) {
  ...
  useEffect(() => {
    // Fetch cinemas if they are not passed down
    if (!cinemaId || !roomId) {
      axios
      ...
      // If cinemaId and roomId are provided, set selectedCinema and selectedRoom
