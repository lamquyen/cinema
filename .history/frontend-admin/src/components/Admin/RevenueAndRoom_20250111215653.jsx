...
function RevenueAndRoom() {
  ...
  const [totalRevenue, setTotalRevenue] = useState({ totalSeatPrice: 0, totalFoodPrice: 0, totalSeat: 0 , totalSeatC: 0,totalSeatV:0, totalSeatC:0 });
  ...
  const calculateTotalRevenue = (data) => {
    ...
    total.totalSeatC += seatC; // Số ghế khác
      ...
      return total;
    }, { totalSeatPrice: 0, totalFoodPrice: 0 , totalSeat: 0, totalSeatN: 0, totalSeatV: 0, totalSeatC: 0});
  };
