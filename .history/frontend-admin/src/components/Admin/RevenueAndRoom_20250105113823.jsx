                    ...
                    <div className='screen hig'>
                        ...
                        <div className='total-revenue-room'>
                            ...
                            <div className='revenue-content'>
                                ...
                                <span>Vé Bán:</span> <span><IoTicketOutline style={{color:'green', marginRight:'10px'}}/>: 60</span> <span><IoTicketOutline style={{color:'red'}}/>: 30</span> <span><IoTicketOutline style={{color:'purple'}}/>: 10</span>
                            </div>
