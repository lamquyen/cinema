...
function Screening() {
  ...
  const handleAddShowtimeClick = (cinemaId, roomId) => {
    const selectedTheater = cinemaData.find((cinema) => cinema.id === cinemaId);
    if (!selectedTheater) return;
    const room = selectedTheater.rooms.find((room) => room.id === roomId);
    setSelectedRoom(room);
                                ...
                                <>
                                  ...
                                  <a
                                    ...
                                    onClick={(e) => {
                                      ...
                                      handleAddShowtimeClick(
                                        theater.id,
                                        selectedRoom?.id // Sử dụng selectedRoom.id thay vì room.id
                                      );
                                    }}
                                  >
                                    Thêm lịch chiếu
