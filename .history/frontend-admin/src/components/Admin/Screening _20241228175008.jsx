                  ...
                  {selectedRoom && (
                    <div className="showtimes">
                      <div className="box-showtime">
                          ...
                          <p>Tên phim: <span>Phim A</span></p>
                          <p>Thời gian: <span>90 phút</span></p>
                          <button className="btn-room">Xem doanh thu</button>
                      </div>
                      <div className="box-showtime">
                          <h4>Suất chiếu 2 (13:00-16:00)</h4>
                          <h5>Phim đang chiếu</h5>
                          <div className="line"></div>
                          <div className="poster">
                            <img src="" />
                          </div>
                          <p>Tên phim: <span>Phim B</span></p>
                          <p>Thời gian: <span>100 phút</span></p>
                          <button className="btn-room">Thay đổi lịch chiếu</button>
                      </div>
                      <div className="box-showtime">
                          <h4>Suất chiếu 3 (17:00-20:00)</h4>
                          <h5>Đã có phim chiếu</h5>
                          <div className="line"></div>
                          <div className="poster">
                            <img src="" />
                          </div>
                          <p>Tên phim: <span>Phim C</span></p>
                          <p>Thời gian: <span>80 phút</span></p>
                          <button className="btn-room">Thay đổi lịch chiếu</button>
                      </div>
                      <div className="box-showtime">
                          <h4>Suất chiếu 4 (21:00)</h4>
                          <h5>Rạp trống</h5>
                          <div className="line"></div>
                         
                          <button className="btn-room">Thêm lịch chiếu</button>
                      </div>
                    </div>
                  )}
                </div>
