...
const getWeekDays = () => {
  const days = [];
  for (let i = 0; i < 14; i++) { // Hiển thị 2 tuần
...
function Screening() {
        ...
        rooms: [
          {
            ...
            showtimes: {
              "2024-12-28": [
                { timeRange: "9:00-12:00", movie: { title: "Phim A", duration: 90, status: "Phim đã chiếu", poster: "url-to-poster-A.jpg" } },
                { timeRange: "13:00-16:00", movie: { title: "Phim B", duration: 100, status: "Phim đang chiếu", poster: "url-to-poster-B.jpg" } },
                { timeRange: "17:00-20:00", movie: { title: "Phim C", duration: 80, status: "Đã có phim chiếu", poster: "url-to-poster-C.jpg" } },
          ...
          },
          {
            ...
            showtimes: {
              "2024-12-28": [
                { timeRange: "9:00-12:00", movie: { title: "Phim D", duration: 90, status: "Phim đã chiếu", poster: "url-to-poster-A.jpg" } },
                { timeRange: "13:00-16:00", movie: { title: "Phim E", duration: 100, status: "Phim đang chiếu", poster: "url-to-poster-B.jpg" } },
                { timeRange: "17:00-20:00", movie:null},
                { timeRange: "21:00", movie: { title: "Phim F", duration: 80, status: "Đã có phim chiếu", poster: "url-to-poster-C.jpg" }  },
              ],
            },
          },
          {
  ...
  {room.showtimes[selectedDate]
    ? room.showtimes[selectedDate].filter((showtime) => showtime.movies !== null).length
    : 0}
  /4
</p>
