      ...
      <div key={room.id} className="room-section">
        ...
        <div className="revenue">
          <table className="table">
            ...
            <tbody>
              {/* Lọc dữ liệu suất chiếu cho phòng hiện tại */}
              {showtimesData
                ...
                .map((showtime) => (
                  <tr key={showtime._id}>
                    ...
                    <td>{showtime.ticketsSold}</td>
                    <td>{showtime.snacksSold}</td>
                    <td>{showtime.revenue.toLocaleString()} đ</td>
                  </tr>
                ))}
              {/* Hiển thị nếu không có suất chiếu */}
              {showtimesData.filter((showtime) => showtime.roomId === room.id)
                .length === 0 && (
                <tr>
